...
def shrink():
    ...
    # otherwise
        ...
        # save state
        imgOrig = img.clone()
        imgNew = Image(Point(midX, midY), 250, 363)
...
def get_cards():
    return ['ace_of_hearts.gif',     '2_of_hearts.gif',
            '3_of_hearts.gif',       '4_of_hearts.gif',
            '5_of_hearts.gif',       '6_of_hearts.gif',
            '7_of_hearts.gif',       '8_of_hearts.gif',
            '9_of_hearts.gif',       '10_of_hearts.gif',
            'jack_of_hearts2.gif',   'queen_of_hearts2.gif',
            'king_of_hearts2.gif',
            'ace_of_diamonds.gif',   '2_of_diamonds.gif',
            '3_of_diamonds.gif',     '4_of_diamonds.gif',
            '5_of_diamonds.gif',     '6_of_diamonds.gif',
            '7_of_diamonds.gif',     '8_of_diamonds.gif',
            '9_of_diamonds.gif',     '10_of_diamonds.gif',
            'jack_of_diamonds2.gif', 'queen_of_diamonds2.gif',
            'king_of_diamonds2.gif',
            'ace_of_clubs.gif',      '2_of_clubs.gif',
            '3_of_clubs.gif',        '4_of_clubs.gif',
            '5_of_clubs.gif',        '6_of_clubs.gif',
            '7_of_clubs.gif',        '8_of_clubs.gif',
            '9_of_clubs.gif',        '10_of_clubs.gif',
            'jack_of_clubs2.gif',    'queen_of_clubs2.gif',
            'king_of_clubs2.gif',
            'ace_of_spades.gif',     '2_of_spades.gif',
            '3_of_spades.gif',       '4_of_spades.gif',
            '5_of_spades.gif',       '6_of_spades.gif',
            '7_of_spades.gif',       '8_of_spades.gif',
            '9_of_spades.gif',       '10_of_spades.gif',
            'jack_of_spades2.gif',   'queen_of_spades2.gif',
            'king_of_spades2.gif']
